...
UDP_PORT = 5005
UDP_PORT_IN = 5006
UDP_IP_DISABLED = "10.142.87.193"
UDP_PORT_DISABLED = 5433
sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
sock_in = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
sock_in.bind((UDP_IP_IN, UDP_PORT_IN))
sock_in.settimeout(0.01)
sock_out_disabled = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
msg_disabled = "Disabled"
sock_out_disabled.sendto(msg_disabled.encode(), (UDP_IP_DISABLED, UDP_PORT_DISABLED))
...
while True:
    try:
        data_in, addr_in = sock_in.recvfrom(1024)
        MESSAGE = "0 0"
    ...
    # No data received, just continue with the rest of the code
        pass
